...
export default function Notifications() {
  ...
  return (
    <div>
      <Navbar />
      <div className="p-4 max-w-lg mx-auto mt-6 bg-neutral-100 rounded">
        <h1 className="text-2xl mb-4 text-neutral-800">Flagged Comments:</h1>
        {flaggedComments.length > 0 ? (
          flaggedComments.map((comment, index) => (
            <div
              key={index}
              className="bg-red-100 border-2 border-red-400 p-3 mb-3 rounded"
            >
              <p className="text-red-600 mb-1">{comment.text}</p>
